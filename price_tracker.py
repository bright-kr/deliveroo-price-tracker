"""
Deliveroo Price Tracker - Bright Data Web Scraper API
----------------------------------------------------
Track prices, availability, and product data from Deliveroo.

Docs  : https://docs.brightdata.co.kr/scraping-automation/web-scraper-api/overview
Info  : https://brightdata.co.kr/products/insights/price-tracker/deliveroo
"""
...
# Set your Web Scraper ID after building your Deliveroo scraper:
# https://brightdata.co.kr/products/web-scraper/deliveroo
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Deliveroo scraper at: https://brightdata.co.kr/products/web-scraper/deliveroo\n"
...
def track_prices(urls: list[str], **kwargs) -> list[dict]:
    """
    Collect price data for a list of Deliveroo product URLs.
...
def discover_by_keyword(keyword: str, limit: int = 50, **kwargs) -> list[dict]:
    """
    Discover Deliveroo products by keyword search.
...
def discover_by_category(category_url: str, limit: int = 100, **kwargs) -> list[dict]:
    """
    Discover all products from a Deliveroo category page.

    Example:
        results = discover_by_category("https://deliveroo.com/s?k=headphones", limit=200)
    """
...
if __name__ == "__main__":
    ...
    sample_urls = [
        "https://www.deliveroo.com/product/sample-item-123456",
        # Add more Deliveroo product URLs here
    ]
    results = track_prices(sample_urls)

    output_file = "deliveroo_prices.json"
    ...
    # cat_results = discover_by_category("https://deliveroo.com/category/sample", limit=50)
